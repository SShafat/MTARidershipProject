...
bar1 = ax1.bar(y_pos,a, align = 'center', color = "blue", label = 'Subway',linewidth = 6)
...
bar2 = ax2.bar(y_pos, a2, align = 'center', color = 'yellow', label = 'Bus')
plt.legend(handles = [bar1,bar2])

#ax1.ylabel('Riders')
plt.title('Subway / bus riders in the last five years')
plt.show()
